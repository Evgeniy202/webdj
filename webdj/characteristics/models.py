...
class CategoryFeature(models.Model):
    ...
    feature_name = models.CharField(verbose_name="Ім'я ключа для категорії", max_length=50)
    feature_filter_name = models.CharField(verbose_name='Імя для фільтра', max_length=50)
    unit = models.CharField(max_length=50, verbose_name='Одинаця виміру', null=True, blank=True)
