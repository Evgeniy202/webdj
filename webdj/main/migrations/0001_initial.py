    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('general_price', models.DecimalField(decimal_places=2, default=0, max_digits=9, verbose_name='Загальна ціна')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postfix', models.CharField(blank=True, max_length=50, null=True, verbose_name='Постфікс')),
                ('filter_use', models.BooleanField(default=False, verbose_name='Використовувати для фільтра')),
                ('filter_type', models.CharField(default='checkbox', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('feature_value', models.CharField(blank=True, max_length=250, null=True, unique=True, verbose_name='Значення характеристики')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.category', verbose_name='Категорія')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='main.cart', verbose_name='Кошик')),
